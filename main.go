...
func Options() {
	...
	case 16:
		color.Blue("Modified by Anmol... If you got this product for more than 40$ then you got scammed dm Anmol to get this product only for 40$ or less if you are a friend")
	case 17:
		// Exit without error
		os.Exit(0)
...
const logo = "Discord mass-DM-GO (modified by anmol"
